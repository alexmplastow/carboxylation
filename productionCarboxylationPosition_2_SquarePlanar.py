...
#NOTE: this approach works fine in the case of stubborn structures, it will skip safely
#NOTE: this approach also works fine in the case of structures which just need a little "push"
